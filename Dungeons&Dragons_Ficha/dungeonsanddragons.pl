...
hit_points(HP_total) :-
  ...
  HP_total is Level * (Class_HP + Mod).
...
weapon_stats(battleaxe,       8, dexterity).
weapon_stats(flail,           8, dexterity).
weapon_stats(glaive,         10, dexterity).
weapon_stats(greataxe,       12, dexterity).
weapon_stats(greatsword,     12, dexterity).
weapon_stats(halberd,        10, dexterity).
weapon_stats(lance,          12, dexterity).
weapon_stats(longsword,       8, dexterity).
weapon_stats(maul,           12, dexterity).
weapon_stats(morningstar,     8, dexterity).
weapon_stats(pike,           10, dexterity).
...
weapon_stats(war_pick,        8, dexterity).
weapon_stats(warhammer,       8, dexterity).
